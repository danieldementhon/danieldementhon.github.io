...
I am using Jupyter notebooks. This blog is more about commenting code that works than about illustrating ideas using code for now, as I have a lot of code that needs explanations. When I am done presenting this backlog, I'll switch to a more exploratory mode, proposing hypotheses and trying to corroborate them with code at the same time.
